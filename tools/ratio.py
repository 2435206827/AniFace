...
def ratio_process(directory, ratio, delete):
...
if __name__ == "__main__":
    ...
    parser.add_argument("-r", "--ratio", type = float, default = 1.1, help = "The aspect ratio threshold, above which the image will no longer be scaled")
    ...
    tot, errs = ratio_process(args["dataset_path"], args["ratio"], args["del"])
